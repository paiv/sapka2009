...
final class ac extends o
{
    ...
    {
        this = ((ac) (am.a(am1).pop()));
        Object obj;
        this = (obj = am.a(am1).pop()).equals(this) ? 0 : -1;
    ...
    {
        return "Checks if variable2 is NOT EQUAL to variable1, returns result at top of stack (0=FALSE or -1=TRUE)\r\n All Types are allowed : <OBJ2> <OBJ1> != -> <INT(BOOLEAN)>  \r\n EXAMPLE: 2 3 != . OUTPUT:-1";
    }
}
